    ...
    <Card className="p-8 bg-white/90 backdrop-blur-sm shadow-xl">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-[2.5rem]">{t('medicine.title')}</h2>
        </div>
        <div className="text-right">
          <p className="text-[2rem] text-primary">{takenCount} {t('common.of')} {medications.length}</p>
          <p className="text-[1.2rem] text-muted-foreground">{t('medicine.taken')}</p>
        </div>
      </div>
